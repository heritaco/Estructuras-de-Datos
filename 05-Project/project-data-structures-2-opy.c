...
Product *updateProduct(Product *root, char *newName, int id, float newCost, int newQuantity, char *newEntryDate, int newPriority)
{
...
int main()
{
    ...
    while (1)
    {
        ...
        case 4:
            ...
            root = updateProduct(root, name, id, cost, quantity, entryDate, priority);
